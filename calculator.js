const calculatorCounter = document.querySelector('.calculator__input');
const calculatorKeys = document.querySelector('.calculator__keys');
// Indentificar todos los botones oprimidos
...
function calculator () {
    ...
    calculatorKeys.addEventListener('click', (e) => {
        ...
        // El textContent para tomar el número que se muestra en el HTML
    ...
    function runOperation (operation) {
        ...
        result.toString().includes('.') ? calculatorCounter.value = result.toFixed(2) 
        : calculatorCounter.value = result

        
        // Luego de ejecutar un igual, no quiero que si no se define otro número tome mi último simbolo para efectuar otras operaciones con las varables ya registradas.
